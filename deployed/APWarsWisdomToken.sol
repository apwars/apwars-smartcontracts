...
// File: contracts/APWarsTokenAccessControl.sol
...
// File: contracts/arcadia/APWarsWisdomToken.sol
    ...
    ERC20Burnable
{
    ...
    function mint(uint256 _amount) public onlyRole(MINTER_ROLE) {
        require(!isClosed, "APWarsWisdomToken:IS_CLOSED");
