const War = artifacts.require('APWarsWarMachineV2');
...
contract('Simple War (with nfts)', accounts => {
  ...
  it('should prepare war', async () => {
    ...
    gold = await UnitToken.new('Gold', 'A:GOLD', 0, 0, 0);
    teamA = await UnitToken.new('Team A Archer', 'A:ARCHER', 15, 50, 10);
    teamB = await UnitToken.new('Team B Archer', 'A:ARCHER', 15, 50, 10);
